...
<div class="container">
  ...
  <Article>
    ...
    <h3>WHY PIPED?</h3>
    <p>on my quest to remove big tech from my life, I run across the youtube problem: I consume youtube video as much as my grandma consumes facebook memes.</p>
    <p>so I asked myself, how can I remove google from my life but still keep my addiction?</p>
    <p>this is where <a href="https://docs.piped.video/" target="_blank" draggable="false">Piped</a> comes in: no data collection, no tracking, no ads, no sponsors and all in a package I can selfhost on my own server.</p>
    <h3>MY SETUP</h3>
    <p>
  ...
  ram: "3GiB allocated + 512MiB swap",
    ...
    />
    <p>an ideal machine has at least 2GiB of memory, especially if you plan on subscribing to a lot of channels // a lot being around 250 channels.</p>
    <p>the disk usage comes from caches and databases for users data, you can always add more later.</p>
    <h3>SETTING UP THE PROXMOX CONTAINER</h3>
    <p>if you're using Proxmox, you might have to pass some additional configuration to get docker to work in an unprivileged container.</p>
    <p>in particular, we want for docker to be able to have access to our network tunnel device.</p>
...
lxc.mount.entry: /dev/net/tun dev/net/tun none bind,create=file`}
    ...
    <p>now we move back to the console of our container.</p>
    <p>before anything else, remember to update all packages:</p>
    <Code
      language="shellscript"
      title="console"
...
`}
    ...
    <p>you can now start subscribing to channels, create playlists and make channel groups.</p>
    <p>I recommend to check out the preferences page and change the default homepage to feed.</p>
    <h3>FIXING FEED NOT UPDATING PROBLEM</h3>
    <p>there is a <a href="https://github.com/TeamPiped/Piped/issues/707" target="_blank" draggable="false">notorious bug</a> where your feed will not auto-update unless you visit a channel manually.</p>
    <p>but with a small fix that won't be a problem for long // <a href="https://github.com/TeamPiped/Piped/issues/707#issuecomment-2958774241" target="_blank" draggable="false">thanks to 0xF4CED on github</a>.</p>
...
POSTGRES_DB=piped`}
    ...
    />
    <p>you can test that your script is working by running the script manually and see if the feed updates.</p>
    ...
    <p>I recommend to redirect all the traffic to youtube to your selfhosted Piped instead.</p>
    <p>you can do so with <a href="https://github.com/libredirect/browser_extension" target="_blank" draggable="false">Libredirect</a> a fenomenal extension to redirect traffic from data farm websites to safe versions, such as google maps to <a href="http://openstreetmap.org/" target="_blank" draggable="false">openstreetmap</a> and reddit to <a href="https://eddrit.com/" target="_blank" draggable="false">eddrit</a>.</p>
    <h3>WHAT ABOUT MY PHONE?</h3>
    <p>if you want to watch youtube on your phone or tablet there are different ways you can approach it.</p>
    <p>you can simply navigate to your selfhosted Piped instance with any browser and watch there, ad free and tracking free.</p>
